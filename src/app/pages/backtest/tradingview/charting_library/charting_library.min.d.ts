...
export const enum OrderTicketFocusControl {
  StopLoss = 1,
  StopPrice = 2,
  TakeProfit = 3,
}
...
export interface IBrokerConnectionAdapterHost {
  ...
  showOrderDialog<T extends PreOrder>(
    order: T,
    handler: (order: T, customFieldsResult?: CustomInputFieldsValues) => Promise<void>,
...
export interface IChartWidgetApi {
  ...
  createStudy<TStudyInputs extends StudyInputValueType, TOverrides extends StudyOverrides>(
    name: string,
